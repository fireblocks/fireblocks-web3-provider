...
export function getFireblocksProviderForTesting(additionalConfig?: any) {
...
export function getEthersFireblocksProviderForTesting(additionalConfig?: any) {
  return new ethers.providers.Web3Provider(getFireblocksProviderForTesting(additionalConfig))
}
